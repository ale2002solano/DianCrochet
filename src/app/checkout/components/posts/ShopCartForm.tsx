...
useEffect(() => {
    ...
    return (
        <div  id="PRINCIPAL" className="flex flex-col lg:flex-row justify-between font-koulen w-full p-8 h-screen overflow-y-auto">
            ...
            <div id="hd1"  className="flex flex-row flex-wrap justify-between items-center sm:items-start content-start space-y-4 sm:space-y-0">
                ...
                <div id="pago" className="text-gray-800">
                    <h1 className="text-base sm:text-1xl mb-3 text-center sm:text-left">Pagos con</h1>
