        ...
        <div className="flex flex-col lg:flex-row justify-between font-koulen w-full p-8">
            ...
            <div id="hd1" className="flex flex-col sm:flex-row justify-between items-start content-start space-y-4 sm:space-y-0">
                ...
                <div id="pago" className="text-gray-800">
                    ...
                    <button className="w-16 sm:w-24 border-blue-900 rounded-md border-2 px-2 py-1 transition-all duration-300 ease-in-out hover:shadow-lg hover:translate-y-[-5px]">
