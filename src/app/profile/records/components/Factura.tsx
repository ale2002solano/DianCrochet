...
export default function Factura({ codigo, productos, fecha, total }: Readonly<FacturaProps>){
    return (
        <div className="select-none h-full ml-4 flex-col sm:flex-row w-full flex p-3 px-8 shadow-[0px_0px_5px_1px_#a7a7a7] rounded-xl">
            ...
            <div className="sm:w-1/6 w-full h-[10%] mt-[17%] sm:mt-0 sm:h-full flex flex-row sm:flex-col justify-between sm:justify-evenly sm:pl-2">
                <div><h1 className="sm:font-roboto mr-2 text-xl sm:text-2xl text-[#4b4a4a]">{Math.floor(total)} Lps</h1></div>
